  ...
  canActivate(
    ...
    return new Promise(resolve => {
      ...
      if (!Base.Store.get("isTemplet")) {
        // 根据域名配置不通路由模块
        this.httpClient.get(Api.gettemple).subscribe(menuGroups => {
          const appnewRoutes: Routes = [
            ...
            },
            {
              path: "login",
              loadChildren:
                "../app/page_module_1/login/login.module#LoginModule",
            ...
            },
            {
              path: "detail",
              loadChildren:
                "../app/page_module_2/detail/detail.module#DetailModule"
            },
            {
              path: "test",
              loadChildren:
                "../app/page_module_2/test/detail.module#DetailModule"
            },
            {
        ...
        if (Base.Store.get("isTemplet") == "1") {
          const appnewRoutes: Routes = [
            ...
            },
            {
              path: "detail",
              loadChildren:
                "../app/page_module_1/detail/detail.module#DetailModule"
            },
            {
              path: "test",
              loadChildren:
                "../app/page_module_1/test/detail.module#DetailModule"
            },
            {
              path: "register",
              loadChildren:
                "../app/page_module_1/register/register.module#RegisterModule"
            },
            {
              path: "index",
              loadChildren:
                "../app/page_module_1/index/index.module#IndexModule"
            },
            {
              path: "**", // 错误路由重定向[写在最后一个],可作为404页面
              redirectTo: "home",
          ...
          const appnewRoutes: Routes = [
            ...
            },
            {
              path: "detail",
              loadChildren:
                "../app/page_module_3/detail/detail.module#DetailModule"
            },
            {
              path: "test",
              loadChildren:
                "../app/page_module_3/test/detail.module#DetailModule"
            },
            {
              path: "**", // 错误路由重定向[写在最后一个],可作为404页面
              redirectTo: "home",
