...
//追号数据结束
	...
	menu_2_data = [
		...
		{
			title:'组选',
			menu:[{name:'复式',index:1,arr:['b','s','g']},{name:'单式',index:2,isupload:true},{name:'直选和值',index:3,arr:['hz26']}],
			active:15
		},
		{
			title:'直选',
			menu:[{name:'组三',index:4,arr:['zu3']},{name:'组六',index:5,arr:['zu6']},{name:'混合组选',index:6,isupload:true},{name:'组选和值',index:7,arr:['dh','2ch']}],
			active:15
		}
	]
