...
//追号数据结束
	...
	public items_show = {
		'fc3d_dpc':{
			'tabitem':[this.now_lang.Lot_tab.Three_star,this.now_lang.Lot_tab.Indeterminate_gallbladder,this.now_lang.Lot_tab.Two_star,this.now_lang.Lot_tab.Gall,this.now_lang.Lot_tab.Size_Dan_Shuang],    
			'reward_show':false,
			'name':this.now_lang.lot_type.fc3d_dpc
		},
		'pl35_dpc':{
			'tabitem':[this.now_lang.Lot_tab.Five_star,this.now_lang.Lot_tab.ForF_star,this.now_lang.Lot_tab.BackF_star,this.now_lang.Lot_tab.BackT_star,this.now_lang.Lot_tab.ForT_star,this.now_lang.Lot_tab.MidT_star,this.now_lang.Lot_tab.Two_star,this.now_lang.Lot_tab.Gall,this.now_lang.Lot_tab.Indeterminate_gallbladder,this.now_lang.Lot_tab.Size_Dan_Shuang,this.now_lang.Lot_tab.Interest,this.now_lang.Lot_tab.Choose_two,this.now_lang.Lot_tab.Choose_three,this.now_lang.Lot_tab.Choose_four],             
			'reward_show':false,
...
//追号函数结束
	...
	ngOnInit(){
		...
		this.route.params.subscribe(data => {
            ...
            // 切换路由后重置投注内容
            this.routid = data.id;
            if(that.url_str[that.routid]){
	            that.routid = that.url_str[that.routid];
            }else{
            	console.error('routid 错误!')
            	return false
            }
            this.getPageId();
            this.balllist(['s','g']);
