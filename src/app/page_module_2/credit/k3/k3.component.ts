...
export class K3Component implements OnInit, OnDestroy, AfterViewInit {
  ...
  public POINt_data = {
    k3data1: {
      data1: [
        { numb: 1, point: 1.743, step: 0.225/7.8 },
        { numb: 2, point: 1.743, step: 0.225/7.8 },
        { numb: 3, point: 1.743, step: 0.225/7.8 },
        { numb: 4, point: 1.743, step: 0.225/7.8 },
        { numb: 5, point: 1.743, step: 0.225/7.8 },
        { numb: 6, point: 1.743, step: 0.225/7.8 },
      ],
      data2: [
    ...
    k3data2: {
      data1: [{ name: "全骰", point: 27.048, step: 2.806/7.8 }],
      data2: [
        { numb: 1, point: 162.288, step: 16.84/7.8 },
        { numb: 2, point: 162.288, step: 16.84/7.8 },
        { numb: 3, point: 162.288, step: 16.84/7.8 },
        { numb: 4, point: 162.288, step: 16.84/7.8 },
        { numb: 5, point: 162.288, step: 16.84/7.8 },
        { numb: 6, point: 162.288, step: 16.84/7.8 }
      ]
    },
    k3data3: {
      data1: [
        { numb: [1, 1], point: 7.893, step: 1.053/7.8 },
        { numb: [2, 2], point: 7.893, step: 1.053/7.8 },
        { numb: [3, 3], point: 7.893, step: 1.053/7.8 },
        { numb: [4, 4], point: 7.893, step: 1.053/7.8 },
        { numb: [5, 5], point: 7.893, step: 1.053/7.8 },
        { numb: [6, 6], point: 7.893, step: 1.053/7.8 }
      ]
    },
    k3data4: {
      data1: [
        { name: "4点", point: 44.096, step: 5.612/7.8 },
        { name: "5点", point: 17.048, step: 2.809/7.8 },
        { name: "6点", point: 13.228, step: 1.684/7.8 },
        { name: "7点", point: 11.819, step: 1.123/7.8 },
        { name: "8点", point: 8.156, step: 0.802/7.8 },
        { name: "9点", point: 6.291, step: 0.674/7.8 },
        { name: "10点", point: 6.344, step: 0.624/7.8 },
        { name: "11点", point: 6.344, step: 0.624/7.8 },
        { name: "12点", point: 6.291, step: 0.674/7.8 },
        { name: "13点", point: 8.156, step: 0.802/7.8 },
        { name: "14点", point: 11.819, step: 1.123/7.8 },
        { name: "15点", point: 13.228, step: 1.684/7.8 },
        { name: "16点", point: 17.048, step: 2.809/7.8 },
        { name: "17点", point: 44.096, step: 5.612/7.8 },
      ]
    },
    k3data5: {
      data1: [
        { numb: [1, 2], point: 5.409, step: 0.562/7.8 },
        { numb: [1, 3], point: 5.409, step: 0.562/7.8 },
        { numb: [1, 4], point: 5.409, step: 0.562/7.8 },
        { numb: [1, 5], point: 5.409, step: 0.562/7.8 },
        { numb: [1, 6], point: 5.409, step: 0.562/7.8 },
        { numb: [2, 3], point: 5.409, step: 0.562/7.8 },
        { numb: [2, 4], point: 5.409, step: 0.562/7.8 },
        { numb: [2, 5], point: 5.409, step: 0.562/7.8 },
        { numb: [2, 6], point: 5.409, step: 0.562/7.8 },
        { numb: [3, 4], point: 5.409, step: 0.562/7.8 },
        { numb: [3, 5], point: 5.409, step: 0.562/7.8 },
        { numb: [3, 6], point: 5.409, step: 0.562/7.8 },
        { numb: [4, 5], point: 5.409, step: 0.562/7.8 },
        { numb: [4, 6], point: 5.409, step: 0.562/7.8 },
        { numb: [5, 6], point: 5.409, step: 0.562/7.8 },
      ]
    }
  };
  public k3data1 = {
  ...
  public k3data2 = {
    title: "全骰、围骰",
    data1: [{ name: "全骰", value: "", point: 0, step: 0 }],
    data2: [
      { numb: 1, value: "", point: 0, step: 0 },
      { numb: 2, value: "", point: 0, step: 0 },
      { numb: 3, value: "", point: 0, step: 0 },
      ...
      { numb: 5, value: "", point: 0, step: 0 },
      { numb: 6, value: "", point: 0, step: 0 },
      { numb: null, value: "", point: 0, step: 0  },
      { numb: null, value: "", point: 0, step: 0  },
      { numb: null, value: "", point: 0, step: 0  }
    ]
  };
  public k3data3 = {
    title: "短牌",
    data1: [
      { numb: [1, 1], value: "", point: 0, step: 0 },
      { numb: [2, 2], value: "", point: 0, step: 0 },
      { numb: [3, 3], value: "", point: 0, step: 0 },
      { numb: [4, 4], value: "", point: 0, step: 0 },
      { numb: [5, 5], value: "", point: 0, step: 0 },
      { numb: [6, 6], value: "", point: 0, step: 0 },
      { numb: null, value: "", point: 0, step: 0  },
      { numb: null, value: "", point: 0, step: 0  },
      { numb: null, value: "", point: 0, step: 0  },
      { numb: null, value: "", point: 0, step: 0  }
