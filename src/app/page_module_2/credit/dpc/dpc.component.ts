...
export class DpcComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  public POINt_data = {
    dpcdata1: {
      ...
      data2: [
        { name: "特大", point: 1.816, step: 0.156 / 7.8 },
        { name: "特小", point: 1.816, step: 0.156 / 7.8 },
        { name: "家禽", point: 1.816, step: 0.156 / 7.8 },
        { name: "野兽", point: 1.816, step: 0.156 / 7.8 },
        { name: "大单", point: 3.592, step: 0.312 / 7.8 },
        { name: "奇", point: 2.553, step: 0.234 / 7.8 },
        { name: "上", point: 2.553, step: 0.234 / 7.8 },
        { name: "特单", point: 1.816, step: 0.156 / 7.8 },
        { name: "特双", point: 1.816, step: 0.156 / 7.8 },
        { name: "总大", point: 1.816, step: 0.155 / 7.8 },
        { name: "总小", point: 1.816, step: 0.156 / 7.8 },
        { name: "大双", point: 3.592, step: 0.312 / 7.8 },
        { name: "奇偶和", point: 2.454, step: 0.233 / 7.8 },
        { name: "上下和", point: 2.454, step: 0.233 / 7.8 },
        { name: "合大", point: 1.816, step: 0.156 / 7.8 },
        { name: "合小", point: 1.816, step: 0.156 / 7.8 },
        { name: "总单", point: 1.816, step: 0.155 / 7.8 },
        { name: "总双", point: 1.816, step: 0.156 / 7.8 },
        { name: "小单", point: 3.592, step: 0.312 / 7.8 },
        { name: "偶", point: 2.553, step: 0.234 / 7.8 },
        { name: "下", point: 2.553, step: 0.234 / 7.8 },
        { name: "合单", point: 1.816, step: 0.156 / 7.8 },
        { name: "合双", point: 1.816, step: 0.156 / 7.8 },
        { name: "合尾大", point: 1.816, step: 0.156 / 7.8 },
        { name: "合尾小", point: 1.816, step: 0.156 / 7.8 },
        { name: "小双", point: 3.592, step: 0.312 / 7.8 },
        { name: "尾大", point: 1.816, step: 0.156 / 7.8 },
        { name: "尾小", point: 1.816, step: 0.156 / 7.8 },
        { name: "红波", point: 2.513, step: 0.324 / 7.8 },
        { name: "蓝波", point: 2.598, step: 0.239 / 7.8 },
        { name: "绿波", point: 2.598, step: 0.239 / 7.8 }
      ]
    },
    dpcdata2: {
      data1: [
        { name: "红单", point: 5.107, step: 0.468 / 7.8 },
        { name: "红双", point: 4.612, step: 0.416 / 7.8 },
        { name: "红大", point: 5.937, step: 0.535 / 7.8 },
        { name: "红小", point: 4.106, step: 0.374 / 7.8 },
        { name: "蓝单", point: 5.107, step: 0.468 / 7.8 },
        { name: "蓝双", point: 5.107, step: 0.468 / 7.8 },
        { name: "蓝大", point: 4.612, step: 0.416 / 7.8 },
        { name: "蓝小", point: 5.937, step: 0.535 / 7.8 },
        { name: "绿单", point: 5.107, step: 0.468 / 7.8 },
        { name: "绿双", point: 5.937, step: 0.535 / 7.8 },
        { name: "绿大", point: 5.107, step: 0.468 / 7.8 },
        { name: "绿小", point: 5.937, step: 0.535 / 7.8 }
      ]
    },
    dpcdata3: {
      data1: [
        { name: "鼠", point: 10.395, step: 0.955 / 7.8 },
        { name: "牛", point: 10.395, step: 0.955 / 7.8 },
        { name: "虎", point: 10.395, step: 0.955 / 7.8 },
        { name: "兔", point: 10.395, step: 0.955 / 7.8 },
        { name: "龙", point: 10.395, step: 0.955 / 7.8 },
        { name: "蛇", point: 10.395, step: 0.955 / 7.8 },
        { name: "马", point: 10.395, step: 0.955 / 7.8 },
        { name: "羊", point: 10.395, step: 0.955 / 7.8 },
        { name: "猴", point: 10.395, step: 0.955 / 7.8 },
        { name: "鸡", point: 10.395, step: 0.955 / 7.8 },
        { name: "狗", point: 8.316, step: 0.764 / 7.8 },
        { name: "猪", point: 10.395, step: 0.955 / 7.8 }
      ]
    },
    dpcdata4: {
    ...
    dpcdata8: {
      data1: [
        { name: "鼠", point: 1.886, step: 0.165 / 7.8 },
        { name: "牛", point: 1.886, step: 0.165 / 7.8 },
        { name: "虎", point: 1.886, step: 0.165 / 7.8 },
        { name: "兔", point: 1.886, step: 0.165 / 7.8 },
        { name: "龙", point: 1.886, step: 0.165 / 7.8 },
        { name: "蛇", point: 1.886, step: 0.165 / 7.8 },
        { name: "马", point: 1.886, step: 0.165 / 7.8 },
        { name: "羊", point: 1.886, step: 0.165 / 7.8 },
        { name: "猴", point: 1.886, step: 0.165 / 7.8 },
        { name: "鸡", point: 1.886, step: 0.165 / 7.8 },
        { name: "狗", point: 1.606, step: 0.141 / 7.8 },
        { name: "猪", point: 1.886, step: 0.165 / 7.8 }
      ]
    },
    dpcdata9: {
      data1: [
            { name: "1尾", point: 1.607, step: 0.14/7.8 },
            { name: "2尾", point: 1.607, step: 0.14/7.8 },
            { name: "3尾", point: 1.607, step: 0.14/7.8 },
            { name: "4尾", point: 1.607, step: 0.14/7.8 },
            { name: "5尾", point: 1.607, step: 0.14/7.8 },
            { name: "6尾", point: 1.607, step: 0.14/7.8 },
            { name: "7尾", point: 1.607, step: 0.14/7.8 },
            { name: "8尾", point: 1.607, step: 0.14/7.8 },
            { name: "9尾", point: 1.607, step: 0.14/7.8 },
            { name: "0尾", point: 1.826, step: 0.165/7.8 },
      ]
    },
    dpcdata10: {
      data1: [
        {name: "合肖一肖",point1: 10.416,point2: 0.95,step1: 0.936/7.8,step2: 0.085/7.8},
        {name: "合肖二肖",point1: 5.208,point2: 1.041,step1: 0.468/7.8,step2: 0.094/7.8},
        {name: "合肖三肖",point1: 3.472,point2: 1.16,step1: 0.312/7.8,step2: 0.104/7.8},
        {name: "合肖四肖",point1: 2.604,point2: 1.307,step1: 0.234/7.8,step2: 0.117/7.8},
        {name: "合肖五肖",point1: 2.103,point2: 1.489,step1: 0.187/7.8,step2: 0.134/7.8},
        {name: "合肖六肖",point1: 1.816,point2: 1.816,step1: 0.156/7.8,step2: 0.156/7.8},
        {name: "合肖七肖",point1: 1.489,point2: 2.083,step1: 0.134/7.8,step2: 0.187/7.8},
        {name: "合肖八肖",point1: 1.307,point2: 2.604,step1: 0.117/7.8,step2: 0.234/7.8},
        {name: "合肖九肖",point1: 1.16,point2: 3.472,step1: 0.104/7.8,step2: 0.312/7.8},
        {name: "合肖十肖",point1: 1.041,point2: 5.208,step1: 0.094/7.8,step2: 0.468/7.8},
        {name: "合肖十一肖",point1: 0.95,point2: 10.416,step1: 0.085/7.8,step2: 0.936/7.8},
      ],
    },
    dpcdata11: {
    ...
    dpcdata12: {
        data1: [
          { name: "鼠", point: 3.8, step: 0.38/ 7.8 },
          { name: "牛", point: 3.8, step: 0.38/ 7.8 },
          { name: "虎", point: 3.8, step: 0.38/ 7.8 },
          { name: "兔", point: 3.8, step: 0.38/ 7.8 },
          { name: "龙", point: 3.8, step: 0.38/ 7.8 },
          { name: "蛇", point: 3.8, step: 0.38/ 7.8 },
          { name: "马", point: 3.8, step: 0.38/ 7.8 },
          { name: "羊", point: 3.8, step: 0.38/ 7.8 },
          { name: "猴", point: 3.8, step: 0.38/ 7.8 },
          { name: "鸡", point: 3.8, step: 0.38/ 7.8 },
          { name: "狗", point: 3.213, step: 0.321 / 7.8 },
          { name: "猪", point: 3.8, step: 0.38 / 7.8 },
        ]
    },
    longhu: {
        long: { name: "龙", point: 1.816, step: 0.156/7.8 },
        hu: { name: "虎", point: 1.816, step: 0.156/7.8 }
      },
  };
  public dpcdata1 = {
    title: "特码",
      ...
      if (_that[str] instanceof Array) {
        ...
        if (
          ...
          if (_that.type === 7) {
            ...
            if (Number(_that.setallmoney.value) > 0) {
              for (let q = 0; q < resutdata.length; q++) {
                ...
                data[l].point = parseFloat((_that[str].data1[0].point+(_that[str].data1[0].step*this.rangevalue)).toFixed(3));
          ...
          if (_that.type === 10) {
            ...
            if (_that[str].checkarr.length >= _that[str].dantuo) {
              ...
              if (Number(_that.setallmoney.value) > 0) {
                ...
                data[l].type = _that[str].title;
                data[l].point =  parseFloat((_that[str].point+(_that[str].step*this.rangevalue)).toFixed(3));
                data[l].money = _that.setallmoney.value;
              }
            }
          }
          ...
          if (_that.type === 12) {
            ...
            if (Number(_that.setallmoney.value) > 0) {
              for (let q = 0; q < resutdata.length; q++) {
                  let nnn = resutdata[q].indexOf(_that.year)>-1?index1:index2; 
                    
                let l = data.length;
                data[l] = Object.assign({}, this.subob);
                data[l].ball = resutdata[q].join(", ");
                data[l].type = _that[str].title;
                data[l].point = parseFloat((_that.dpcdata12.data1[nnn].point+(_that.dpcdata12.data1[nnn].step*this.rangevalue)).toFixed(3));
                data[l].money = _that.setallmoney.value;
              }
            }
          }
  ...
  setShengxiaoPoint(p, s) {
    ...
    for (let i = 0; i < shengxiao.length; i++) {
      let d = { name: shengxiao[i], point: p, step: s };
      data.push(d);
    }
    return data;
  }
  setZhengmaPoint() {
    let data = [
      { name: "单", point: 1.816, step: 0.156 / 7.8 },
      { name: "双", point: 1.816, step: 0.156 / 7.8 },
      { name: "大", point: 1.816, step: 0.156 / 7.8 },
      { name: "小", point: 1.816, step: 0.156 / 7.8 },
      { name: "合单", point: 1.816, step: 0.156 / 7.8 },
      { name: "合双", point: 1.816, step: 0.156 / 7.8 },
      { name: "红波", point: 2.513, step: 0.324 / 7.8 },
      { name: "蓝波", point: 2.598, step: 0.239 / 7.8 },
