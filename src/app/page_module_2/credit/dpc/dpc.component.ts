...
export class DpcComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    hexiaoclick(i,n) {
        ...
        if (this.radvalue === "合肖六肖 - 中" || this.radvalue === "合肖六肖 - 不中") {
            if (n===2) {
                let t = 2 + i
                this.NOTEtip(t);
            }else{
    ...
    radchange(i, n) {
        ...
        this.dpcdata10.point = n===1?this.data10_1[i].point1:this.data10_1[i].point2;
        this.dpcdata10.step = n===1?this.data10_1[i].step1:this.data10_1[i].step2;
    ...
    sub() {
        ...
        if (this.type == 13) {
            ...
            if (_that[str] instanceof Array) {
                ...
                let d1 = _that[str].data1;
                let d2 = _that[str].data2;
                if (_that.type === 7 || _that.type === 12 || _that.type === 10 || _that.type === 11) {
                    ...
                    if (_that.type === 7) {
                        ...
                        if (op.lianmaactive === 2 || op.lianmaactive === 3 || op.lianmaactive === 4) {
                    ...
                    if (_that.type === 11){
                         ...
                         if (_that[str].checkarr.length>= (_that[str].dantuo+1)){
                             let resutdata = [];
                             resutdata = _that[str].checkarr.sort((a,b)=>{return a-b})
                             if (Number(_that.setallmoney.value) > 0){
                                let l = data.length;
                                data[l] = Object.assign({}, this.subob);
                                data[l].ball = resutdata.join(", ");
