...
export class Gxk10Component implements OnInit, OnDestroy, AfterViewInit {
    ...
    public POINt_data = {
      ...
      betdatab2_1:{
          data1: [
              ...
              { numb: 21, point: 18, step: 1.56/7.8 },
          ],
          data2: [
            { name: "红波", value: "", point: 2.354, step: 0.234/7.8 },
            { name: "蓝波", value: "", point: 2.354, step: 0.234/7.8 },
            { name: "绿波", value: "", point: 2.354, step: 0.234/7.8 },
              ...
              { name: "总尾大", point: 1.8, step: 0.156/7.8 },
              { name: "总尾小", point: 1.8, step: 0.156/7.8 },
              { name: "福", value: "", point: 3.172, step: 0.312/7.8 },
              { name: "禄", value: "", point: 3.172, step: 0.312/7.8 },
              { name: "寿", value: "", point: 3.172, step: 0.312/7.8 },
              { name: "喜", value: "", point: 3.172, step: 0.312/7.8 },
              { name: "合单", point: 1.8, step: 0.156/7.8 },
              { name: "合双", point: 1.8, step: 0.156/7.8 },
            ]
      ...
      bettatab8_1:[
          ...
          { numb: 21, point: 2.095, step: 0.195 },
      ]
    };
  ...
  public betdatab2_1 = {
    ...
    data3: [
      ...
      { name: "总尾大", value: "", point: 0, step: 0 },
      { name: "总尾小", value: "", point: 0, step: 0 },
      { name: "福", value: "", point: 0, step: 0 },
      { name: "禄", value: "", point: 0, step: 0 },
      { name: "寿", value: "", point: 0, step: 0 },
      { name: "喜", value: "", point: 0, step: 0 },
      { name: "合单", value: "", point: 0, step: 0 },
      { name: "合双", value: "", point: 0, step: 0 }
    ]
  };
