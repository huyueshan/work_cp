...
export class CanvasComponent
  ...
  // 页面数据
  public gamelist = {
      ssc :{title:["号码分布", "万位", "千位", "百位", "十位", "个位",], min:0, max:9, len:10, length:5, width:1460, left:0, },
      exf :{title:["号码分布", "万位", "千位", "百位", "十位", "个位", ], min:1, max:11, len:11, length:5, width:1600, left:0, },
      pk10 :{title:["号码分布", "冠军", "亚军", "季军", "第四名", "第五名", "第六名", "第七名", "第八名", "第九名", "第十名", ], min:1, max:10, len:10, length:10, width:2500, left:0, },
      fc3d :{title:["号码分布", "百位", "十位", "个位", ], min:0, max:9, len:10, length:3, width:1000, left:180, },
      k3 :{title:["号码分布", "百位", "十位", "个位", ], min:1, max:6, len:6, length:3, width:660, left:350, },
  };
  public game;
  public thdata;
