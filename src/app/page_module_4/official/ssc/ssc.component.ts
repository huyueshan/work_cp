...
export class SSCofficialComponent implements OnInit {
    ...
    public items_show = {
        ...
        'cq_ssc':{
            'tabitem':[this.now_lang.Lot_tab.Five_star,this.now_lang.Lot_tab.ForF_star,this.now_lang.Lot_tab.BackF_star,this.now_lang.Lot_tab.BackT_star,this.now_lang.Lot_tab.ForT_star,this.now_lang.Lot_tab.MidT_star,this.now_lang.Lot_tab.Two_star,this.now_lang.Lot_tab.Gall,this.now_lang.Lot_tab.Indeterminate_gallbladder,this.now_lang.Lot_tab.Size_Dan_Shuang,this.now_lang.Lot_tab.Interest,this.now_lang.Lot_tab.Choose_two,this.now_lang.Lot_tab.Choose_three,this.now_lang.Lot_tab.Dragon_tiger],
            'reward_show':false,
